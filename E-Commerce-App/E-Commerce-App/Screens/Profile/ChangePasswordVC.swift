...
class ChangePasswordVC: UIViewController {
    ...
    // MARK: - Properties
    private let HeadLabel                 = TitleLabel(fontSize: 20, textAlignment: .left)
    ...
    private lazy var resetButton          = CustomButton( bgColor: .productCollectionFavoriteButtonBG ,color: .productCollectionFavoriteButtonBG, title: "Reset", fontSize: 22)
